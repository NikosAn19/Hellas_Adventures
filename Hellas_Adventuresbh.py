    ...
    def ai(self):
        if self.alive and player.alive:
            ...
            if self.vision.colliderect(player.rect):
                #  enemy faces the player before shooting
                ...
                if tile >= 0:
                    ...
                    if tile >= 0 and tile <= 8:
                        ...
                        if self.male_selected:
                            player = Player('player', x * TILE_SIZE, y * TILE_SIZE, 1.15, 6)
                        elif self.male_selected == False:
                            player = Player('player_female', x * TILE_SIZE, y * TILE_SIZE, 1.15, 6)
                        # self.player = player
...
class ItemBox(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        # scroll
        self.rect.x += screen_scroll
        # check if the player has picked up the letters
...
# letter items, defined as buttons but used as placeholders
...
#define the collected words for the game dictionary
...
#                       grades_shown = True
                    if proceed_to_credit:
                        ...
                        if level == 1:
                            ...
                            if timer.get_elapsed_time() < 60:
                                screen.blit(grade_a_img, (300, 450))
                                print('image blited')
                            elif 60 < timer.get_elapsed_time() <= 80:
                                screen.fill((0, 0, 0))
                                screen.blit(grade_b_img, (350, 150))
